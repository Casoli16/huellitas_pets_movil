        ...
        <ScrollView contentContainerStyle={styles.scrollContainer}>
            <View style={styles.container}>
                <View style={styles.header}>
                    <IconButton icon="history" size={35} onPress={goToWelcome}/>
                </View>
                <View style={styles.col}>
                    ...
                    <View style={styles.inputBox}>
                        ...
                        <View style={styles.buttonContainer}>
                            <CustomButton title='Editar' colorText='white' buttonColor='#EE964B' fontSize={16} buttonMargin={10} onPress={goToWelcome}/>
                            <CustomButton title='Actualizar contraseña' colorText='white' buttonColor='#F95738' fontSize={16} onPress={goToWelcome}/>
                        </View>
